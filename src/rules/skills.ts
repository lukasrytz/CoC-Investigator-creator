...
export const SKILLS: readonly SkillDef[] = [
  ...
  { id: 'animal-handling', name: 'Animal Handling', base: 5, category: 'physical', tags: ['uncommon'] },
  { id: 'anthropology', name: 'Anthropology', base: 1, category: 'mental' },
  { id: 'artillery', name: 'Artillery', base: 1, category: 'combat', tags: ['uncommon'] },
  ...
  { id: 'computer-use', name: 'Computer Use', base: 5, category: 'technical', tags: ['modern'] },
  ...
  { id: 'demolitions', name: 'Demolitions', base: 1, category: 'technical', tags: ['uncommon'] },
  { id: 'disguise', name: 'Disguise', base: 5, category: 'technical' },
  { id: 'diving', name: 'Diving', base: 1, category: 'physical', tags: ['uncommon'] },
  { id: 'dodge', name: 'Dodge', base: 'halfDEX', category: 'combat' },
  { id: 'electronics', name: 'Electronics', base: 1, category: 'technical', tags: ['modern'] },
  ...
  { id: 'hypnosis', name: 'Hypnosis', base: 1, category: 'mental', tags: ['uncommon'] },
  ...
  { id: 'lore', name: 'Lore', base: 1, category: 'mental', specializable: true, tags: ['uncommon'] },
  ...
  { id: 'read-lips', name: 'Read Lips', base: 1, category: 'perception', tags: ['uncommon'] },
